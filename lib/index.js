...
const url$1 = process.env.PRESTAMOS_URL || 'historial-ms';
const port$1 = process.env.PRESTAMOS_PORT || '3002';
const entryPoint$1 = process.env.PRESTAMOS_ENTRY || 'prestamos';
...
const resolvers$1 = {
	...
	Mutation: {
		createPrestamo: (_, { prestamo }) =>
			generalRequest(`${URL$1}`, 'POST', prestamo),
		updatePrestamo: (_, { id, prestamo }) =>
			generaluserRequest(`${URL$1}/${id}`, 'PATCH', prestamo),
		deletePrestamo: (_, { id }) =>
